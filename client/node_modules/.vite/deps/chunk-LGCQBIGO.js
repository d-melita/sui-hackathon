...
import {
  ...
  normalizeSuiAddress,
  suiBcs
} from "./chunk-UDRYGL2D.js";
import {
  fromBase64,
  fromHex,
  toBase64,
  toHex
} from "./chunk-G7BZ2WW6.js";
...
var _GTElement = class _GTElement2 {
  ...
  toBytes() {
    ...
    const result = new Uint8Array(_GTElement2.SIZE);
...
// node_modules/@mysten/seal/node_modules/@noble/hashes/esm/crypto.js
var crypto2 = typeof globalThis === "object" && "crypto" in globalThis ? globalThis.crypto : void 0;

// node_modules/@mysten/seal/node_modules/@noble/hashes/esm/utils.js
function isBytes2(a) {
...
// node_modules/@mysten/seal/node_modules/@noble/hashes/esm/hmac.js
...
// node_modules/@mysten/seal/node_modules/@noble/hashes/esm/_u64.js
...
// node_modules/@mysten/seal/node_modules/@noble/hashes/esm/sha3.js
var _0n4 = BigInt(0);
var _1n4 = BigInt(1);
var _2n4 = BigInt(2);
var _7n = BigInt(7);
...
var Hmac256Ctr = class _Hmac256Ctr {
  ...
  static async decrypt(key, ciphertext) {
    ...
    if (!equalBytes2(mac, new Uint8Array(ciphertext.Hmac256Ctr.mac))) {
...
_cachedPublicKeys = /* @__PURE__ */ new WeakMap();
...
var MultiSigPublicKey = class _MultiSigPublicKey extends PublicKey {
  ...
  toSuiAddress() {
    ...
    return normalizeSuiAddress(bytesToHex2(blake2b(tmp.slice(0, i), { dkLen: 32 })));
  }
  /**
   * Return the Sui address associated with this MultiSig public key
   */
...
var _SessionKey = class _SessionKey2 {
  constructor({
    ...
    __privateSet3(this, _mvrName, mvrName);
    ...
    __privateSet3(this, _suiClient2, suiClient);
  }
  /**
  ...
  getPackageName() {
    if (__privateGet3(this, _mvrName)) {
      return __privateGet3(this, _mvrName);
    }
  ...
  getPersonalMessage() {
    ...
    const message = `Accessing keys of package ${this.getPackageName()} for ${__privateGet3(this, _ttlMin)} mins from ${creationTimeUtc}, session key ${toBase64(__privateGet3(this, _sessionKey).getPublicKey().toRawBytes())}`;
    ...
    if (!__privateGet3(this, _personalMessageSignature)) {
      try {
        await verifyPersonalMessageSignature(this.getPersonalMessage(), personalMessageSignature, {
          ...
          client: __privateGet3(this, _suiClient2)
        });
  ...
  async getCertificate() {
    ...
    return {
      ...
      mvr_name: __privateGet3(this, _mvrName)
    };
  }
  /**
  ...
  export() {
    const obj = {
      address: __privateGet3(this, _address),
      packageId: __privateGet3(this, _packageId),
      mvrName: __privateGet3(this, _mvrName),
      creationTimeMs: __privateGet3(this, _creationTimeMs),
      ttlMin: __privateGet3(this, _ttlMin),
      personalMessageSignature: __privateGet3(this, _personalMessageSignature),
      sessionKey: __privateGet3(this, _sessionKey).getSecretKey()
  ...
  static import(data, suiClient, signer) {
    ...
    __privateSet3(instance, _creationTimeMs, data.creationTimeMs);
    __privateSet3(instance, _sessionKey, Ed25519Keypair.fromSecretKey(data.sessionKey));
    __privateSet3(instance, _personalMessageSignature, data.personalMessageSignature);
...
*/
//# sourceMappingURL=chunk-LGCQBIGO.js.map
