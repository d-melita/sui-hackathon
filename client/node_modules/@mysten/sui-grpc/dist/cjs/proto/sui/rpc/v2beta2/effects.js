...
__export(effects_exports, {
  ...
  UnchangedSharedObject: () => UnchangedSharedObject,
  UnchangedSharedObject_UnchangedSharedObjectKind: () => UnchangedSharedObject_UnchangedSharedObjectKind
});
...
class TransactionEffects$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        4:
          message.status = import_execution_status.ExecutionStatus.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.status
        ...
        6:
          message.gasUsed = import_gas_cost_summary.GasCostSummary.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.gasUsed
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.status)
      import_execution_status.ExecutionStatus.internalBinaryWrite(
        message.status,
        writer.tag(4, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
    if (message.epoch !== void 0) writer.tag(5, import_runtime.WireType.Varint).uint64(message.epoch);
    if (message.gasUsed)
    ...
    if (message.transactionDigest !== void 0)
      writer.tag(7, import_runtime.WireType.LengthDelimited).string(message.transactionDigest);
    ...
    if (message.eventsDigest !== void 0)
      writer.tag(9, import_runtime.WireType.LengthDelimited).string(message.eventsDigest);
    for (let i = 0; i < message.dependencies.length; i++)
      writer.tag(10, import_runtime.WireType.LengthDelimited).string(message.dependencies[i]);
    if (message.lamportVersion !== void 0)
      writer.tag(11, import_runtime.WireType.Varint).uint64(message.lamportVersion);
    ...
    for (let i = 0; i < message.unchangedSharedObjects.length; i++)
      UnchangedSharedObject.internalBinaryWrite(
        ...
        writer.tag(13, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
    if (message.auxiliaryDataDigest !== void 0)
      writer.tag(14, import_runtime.WireType.LengthDelimited).string(message.auxiliaryDataDigest);
...
class ChangedObject$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        5:
          message.inputOwner = import_owner.Owner.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.inputOwner
        ...
        9:
          message.outputOwner = import_owner.Owner.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.outputOwner
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.inputState !== void 0) writer.tag(2, import_runtime.WireType.Varint).int32(message.inputState);
    if (message.inputVersion !== void 0)
      writer.tag(3, import_runtime.WireType.Varint).uint64(message.inputVersion);
    if (message.inputDigest !== void 0)
      writer.tag(4, import_runtime.WireType.LengthDelimited).string(message.inputDigest);
    ...
    if (message.outputState !== void 0)
      writer.tag(6, import_runtime.WireType.Varint).int32(message.outputState);
    if (message.outputVersion !== void 0)
      writer.tag(7, import_runtime.WireType.Varint).uint64(message.outputVersion);
    if (message.outputDigest !== void 0)
      writer.tag(8, import_runtime.WireType.LengthDelimited).string(message.outputDigest);
    ...
    if (message.idOperation !== void 0)
      writer.tag(10, import_runtime.WireType.Varint).int32(message.idOperation);
    if (message.objectType !== void 0)
      writer.tag(11, import_runtime.WireType.LengthDelimited).string(message.objectType);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class UnchangedSharedObject$Type extends import_runtime4.MessageType {
  constructor() {
