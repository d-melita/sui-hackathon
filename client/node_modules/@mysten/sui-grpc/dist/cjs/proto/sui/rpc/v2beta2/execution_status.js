...
class ExecutionStatus$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.success !== void 0) writer.tag(1, import_runtime.WireType.Varint).bool(message.success);
    if (message.error)
...
class ExecutionError$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.description !== void 0)
      writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.description);
    if (message.command !== void 0) writer.tag(2, import_runtime.WireType.Varint).uint64(message.command);
    if (message.kind !== void 0) writer.tag(3, import_runtime.WireType.Varint).int32(message.kind);
    ...
    if (message.errorDetails.oneofKind === "objectId")
      writer.tag(10, import_runtime.WireType.LengthDelimited).string(message.errorDetails.objectId);
    ...
    if (message.errorDetails.oneofKind === "congestedObjects")
      CongestedObjects.internalBinaryWrite(
        message.errorDetails.congestedObjects,
        writer.tag(12, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
...
class MoveAbort$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.abortCode !== void 0) writer.tag(1, import_runtime.WireType.Varint).uint64(message.abortCode);
    if (message.location)
...
class MoveLocation$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.function !== void 0) writer.tag(3, import_runtime.WireType.Varint).uint32(message.function);
    if (message.instruction !== void 0)
      writer.tag(4, import_runtime.WireType.Varint).uint32(message.instruction);
    if (message.functionName !== void 0)
      writer.tag(5, import_runtime.WireType.LengthDelimited).string(message.functionName);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class CleverError$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.errorCode !== void 0) writer.tag(1, import_runtime.WireType.Varint).uint64(message.errorCode);
    if (message.lineNumber !== void 0) writer.tag(2, import_runtime.WireType.Varint).uint64(message.lineNumber);
    if (message.constantName !== void 0)
      writer.tag(3, import_runtime.WireType.LengthDelimited).string(message.constantName);
    if (message.constantType !== void 0)
      writer.tag(4, import_runtime.WireType.LengthDelimited).string(message.constantType);
    if (message.value.oneofKind === "rendered")
      writer.tag(5, import_runtime.WireType.LengthDelimited).string(message.value.rendered);
    if (message.value.oneofKind === "raw")
      writer.tag(6, import_runtime.WireType.LengthDelimited).bytes(message.value.raw);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class SizeError$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.size !== void 0) writer.tag(1, import_runtime.WireType.Varint).uint64(message.size);
    if (message.maxSize !== void 0) writer.tag(2, import_runtime.WireType.Varint).uint64(message.maxSize);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class IndexError$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.index !== void 0) writer.tag(1, import_runtime.WireType.Varint).uint32(message.index);
    if (message.subresult !== void 0) writer.tag(2, import_runtime.WireType.Varint).uint32(message.subresult);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class CoinDenyListError$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.address !== void 0)
      writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.address);
...
class CongestedObjects$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    for (let i = 0; i < message.objects.length; i++)
      writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.objects[i]);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class CommandArgumentError$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.argument !== void 0) writer.tag(1, import_runtime.WireType.Varint).uint32(message.argument);
    if (message.kind !== void 0) writer.tag(2, import_runtime.WireType.Varint).int32(message.kind);
...
class PackageUpgradeError$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.packageId !== void 0)
      writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.packageId);
    if (message.digest !== void 0)
      writer.tag(3, import_runtime.WireType.LengthDelimited).string(message.digest);
    if (message.policy !== void 0) writer.tag(4, import_runtime.WireType.Varint).uint32(message.policy);
    if (message.ticketId !== void 0)
      writer.tag(5, import_runtime.WireType.LengthDelimited).string(message.ticketId);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class TypeArgumentError$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.typeArgument !== void 0)
      writer.tag(1, import_runtime.WireType.Varint).uint32(message.typeArgument);
    if (message.kind !== void 0) writer.tag(2, import_runtime.WireType.Varint).int32(message.kind);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
