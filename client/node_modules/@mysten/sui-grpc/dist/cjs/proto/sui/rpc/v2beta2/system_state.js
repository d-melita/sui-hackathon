...
class SystemState$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.protocolVersion !== void 0)
      writer.tag(3, import_runtime.WireType.Varint).uint64(message.protocolVersion);
    ...
    if (message.referenceGasPrice !== void 0)
      writer.tag(7, import_runtime.WireType.Varint).uint64(message.referenceGasPrice);
    ...
    if (message.safeMode !== void 0) writer.tag(10, import_runtime.WireType.Varint).bool(message.safeMode);
    if (message.safeModeStorageRewards !== void 0)
      writer.tag(11, import_runtime.WireType.Varint).uint64(message.safeModeStorageRewards);
    if (message.safeModeComputationRewards !== void 0)
      writer.tag(12, import_runtime.WireType.Varint).uint64(message.safeModeComputationRewards);
    if (message.safeModeStorageRebates !== void 0)
      writer.tag(13, import_runtime.WireType.Varint).uint64(message.safeModeStorageRebates);
    if (message.safeModeNonRefundableStorageFee !== void 0)
      writer.tag(14, import_runtime.WireType.Varint).uint64(message.safeModeNonRefundableStorageFee);
    if (message.epochStartTimestampMs !== void 0)
      writer.tag(15, import_runtime.WireType.Varint).uint64(message.epochStartTimestampMs);
    if (message.extraFields)
      MoveTable.internalBinaryWrite(
        message.extraFields,
        writer.tag(16, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
...
class ValidatorReportRecord$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.reported !== void 0)
      writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.reported);
    for (let i = 0; i < message.reporters.length; i++)
      writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.reporters[i]);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class SystemParameters$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.epochDurationMs !== void 0)
      writer.tag(1, import_runtime.WireType.Varint).uint64(message.epochDurationMs);
    if (message.stakeSubsidyStartEpoch !== void 0)
      writer.tag(2, import_runtime.WireType.Varint).uint64(message.stakeSubsidyStartEpoch);
    if (message.minValidatorCount !== void 0)
      writer.tag(3, import_runtime.WireType.Varint).uint64(message.minValidatorCount);
    if (message.maxValidatorCount !== void 0)
      writer.tag(4, import_runtime.WireType.Varint).uint64(message.maxValidatorCount);
    if (message.minValidatorJoiningStake !== void 0)
      writer.tag(5, import_runtime.WireType.Varint).uint64(message.minValidatorJoiningStake);
    if (message.validatorLowStakeThreshold !== void 0)
      writer.tag(6, import_runtime.WireType.Varint).uint64(message.validatorLowStakeThreshold);
    if (message.validatorVeryLowStakeThreshold !== void 0)
      writer.tag(7, import_runtime.WireType.Varint).uint64(message.validatorVeryLowStakeThreshold);
    if (message.validatorLowStakeGracePeriod !== void 0)
      writer.tag(8, import_runtime.WireType.Varint).uint64(message.validatorLowStakeGracePeriod);
    if (message.extraFields)
      MoveTable.internalBinaryWrite(
        message.extraFields,
        writer.tag(9, import_runtime.WireType.LengthDelimited).fork(),
...
class MoveTable$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.size !== void 0) writer.tag(2, import_runtime.WireType.Varint).uint64(message.size);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class StakeSubsidy$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.balance !== void 0) writer.tag(1, import_runtime.WireType.Varint).uint64(message.balance);
    if (message.distributionCounter !== void 0)
      writer.tag(2, import_runtime.WireType.Varint).uint64(message.distributionCounter);
    if (message.currentDistributionAmount !== void 0)
      writer.tag(3, import_runtime.WireType.Varint).uint64(message.currentDistributionAmount);
    if (message.stakeSubsidyPeriodLength !== void 0)
      writer.tag(4, import_runtime.WireType.Varint).uint64(message.stakeSubsidyPeriodLength);
    if (message.stakeSubsidyDecreaseRate !== void 0)
      writer.tag(5, import_runtime.WireType.Varint).uint32(message.stakeSubsidyDecreaseRate);
    if (message.extraFields)
      MoveTable.internalBinaryWrite(
        message.extraFields,
        writer.tag(6, import_runtime.WireType.LengthDelimited).fork(),
...
class StorageFund$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.totalObjectStorageRebates !== void 0)
      writer.tag(1, import_runtime.WireType.Varint).uint64(message.totalObjectStorageRebates);
    if (message.nonRefundableBalance !== void 0)
      writer.tag(2, import_runtime.WireType.Varint).uint64(message.nonRefundableBalance);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class ValidatorSet$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.totalStake !== void 0) writer.tag(1, import_runtime.WireType.Varint).uint64(message.totalStake);
    ...
    for (let k of globalThis.Object.keys(message.atRiskValidators))
      writer.tag(8, import_runtime.WireType.LengthDelimited).fork().tag(1, import_runtime.WireType.LengthDelimited).string(k).tag(2, import_runtime.WireType.Varint).uint64(message.atRiskValidators[k]).join();
    if (message.extraFields)
      MoveTable.internalBinaryWrite(
        message.extraFields,
        writer.tag(9, import_runtime.WireType.LengthDelimited).fork(),
...
class Validator$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.name !== void 0) writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.name);
    if (message.address !== void 0)
      writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.address);
    ...
    if (message.imageUrl !== void 0)
      writer.tag(4, import_runtime.WireType.LengthDelimited).string(message.imageUrl);
    if (message.projectUrl !== void 0)
      writer.tag(5, import_runtime.WireType.LengthDelimited).string(message.projectUrl);
    if (message.protocolPublicKey !== void 0)
      writer.tag(7, import_runtime.WireType.LengthDelimited).bytes(message.protocolPublicKey);
    if (message.proofOfPossession !== void 0)
      writer.tag(8, import_runtime.WireType.LengthDelimited).bytes(message.proofOfPossession);
    if (message.networkPublicKey !== void 0)
      writer.tag(10, import_runtime.WireType.LengthDelimited).bytes(message.networkPublicKey);
    if (message.workerPublicKey !== void 0)
      writer.tag(12, import_runtime.WireType.LengthDelimited).bytes(message.workerPublicKey);
    if (message.networkAddress !== void 0)
      writer.tag(13, import_runtime.WireType.LengthDelimited).string(message.networkAddress);
    if (message.p2PAddress !== void 0)
      writer.tag(14, import_runtime.WireType.LengthDelimited).string(message.p2PAddress);
    if (message.primaryAddress !== void 0)
      writer.tag(15, import_runtime.WireType.LengthDelimited).string(message.primaryAddress);
    if (message.workerAddress !== void 0)
      writer.tag(16, import_runtime.WireType.LengthDelimited).string(message.workerAddress);
    if (message.nextEpochProtocolPublicKey !== void 0)
      writer.tag(18, import_runtime.WireType.LengthDelimited).bytes(message.nextEpochProtocolPublicKey);
    if (message.nextEpochProofOfPossession !== void 0)
      writer.tag(19, import_runtime.WireType.LengthDelimited).bytes(message.nextEpochProofOfPossession);
    if (message.nextEpochNetworkPublicKey !== void 0)
      writer.tag(21, import_runtime.WireType.LengthDelimited).bytes(message.nextEpochNetworkPublicKey);
    if (message.nextEpochWorkerPublicKey !== void 0)
      writer.tag(23, import_runtime.WireType.LengthDelimited).bytes(message.nextEpochWorkerPublicKey);
    if (message.nextEpochNetworkAddress !== void 0)
      writer.tag(24, import_runtime.WireType.LengthDelimited).string(message.nextEpochNetworkAddress);
    if (message.nextEpochP2PAddress !== void 0)
      writer.tag(25, import_runtime.WireType.LengthDelimited).string(message.nextEpochP2PAddress);
    if (message.nextEpochPrimaryAddress !== void 0)
      writer.tag(26, import_runtime.WireType.LengthDelimited).string(message.nextEpochPrimaryAddress);
    if (message.nextEpochWorkerAddress !== void 0)
      writer.tag(27, import_runtime.WireType.LengthDelimited).string(message.nextEpochWorkerAddress);
    if (message.metadataExtraFields)
      MoveTable.internalBinaryWrite(
        message.metadataExtraFields,
        writer.tag(28, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
    if (message.votingPower !== void 0)
      writer.tag(29, import_runtime.WireType.Varint).uint64(message.votingPower);
    if (message.operationCapId !== void 0)
      writer.tag(30, import_runtime.WireType.LengthDelimited).string(message.operationCapId);
    if (message.gasPrice !== void 0) writer.tag(31, import_runtime.WireType.Varint).uint64(message.gasPrice);
    if (message.stakingPool)
      StakingPool.internalBinaryWrite(
        message.stakingPool,
        writer.tag(32, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
    if (message.commissionRate !== void 0)
      writer.tag(33, import_runtime.WireType.Varint).uint64(message.commissionRate);
    if (message.nextEpochStake !== void 0)
      writer.tag(34, import_runtime.WireType.Varint).uint64(message.nextEpochStake);
    if (message.nextEpochGasPrice !== void 0)
      writer.tag(35, import_runtime.WireType.Varint).uint64(message.nextEpochGasPrice);
    if (message.nextEpochCommissionRate !== void 0)
      writer.tag(36, import_runtime.WireType.Varint).uint64(message.nextEpochCommissionRate);
    if (message.extraFields)
      MoveTable.internalBinaryWrite(
        message.extraFields,
        writer.tag(37, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
...
class StakingPool$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.activationEpoch !== void 0)
      writer.tag(2, import_runtime.WireType.Varint).uint64(message.activationEpoch);
    if (message.deactivationEpoch !== void 0)
      writer.tag(3, import_runtime.WireType.Varint).uint64(message.deactivationEpoch);
    if (message.suiBalance !== void 0) writer.tag(4, import_runtime.WireType.Varint).uint64(message.suiBalance);
    if (message.rewardsPool !== void 0)
      writer.tag(5, import_runtime.WireType.Varint).uint64(message.rewardsPool);
    if (message.poolTokenBalance !== void 0)
      writer.tag(6, import_runtime.WireType.Varint).uint64(message.poolTokenBalance);
    ...
    if (message.pendingStake !== void 0)
      writer.tag(8, import_runtime.WireType.Varint).uint64(message.pendingStake);
    if (message.pendingTotalSuiWithdraw !== void 0)
      writer.tag(9, import_runtime.WireType.Varint).uint64(message.pendingTotalSuiWithdraw);
    if (message.pendingPoolTokenWithdraw !== void 0)
      writer.tag(10, import_runtime.WireType.Varint).uint64(message.pendingPoolTokenWithdraw);
    if (message.extraFields)
      MoveTable.internalBinaryWrite(
        message.extraFields,
