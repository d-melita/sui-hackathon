...
declare class ValidatorReportRecord$Type extends MessageType<ValidatorReportRecord> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ValidatorReportRecord): ValidatorReportRecord;
    internalBinaryWrite(message: ValidatorReportRecord, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
declare class MoveTable$Type extends MessageType<MoveTable> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MoveTable): MoveTable;
    internalBinaryWrite(message: MoveTable, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
declare class StakeSubsidy$Type extends MessageType<StakeSubsidy> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StakeSubsidy): StakeSubsidy;
    internalBinaryWrite(message: StakeSubsidy, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
declare class StorageFund$Type extends MessageType<StorageFund> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: StorageFund): StorageFund;
    internalBinaryWrite(message: StorageFund, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
