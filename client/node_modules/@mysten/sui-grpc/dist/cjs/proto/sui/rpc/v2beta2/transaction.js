...
var import_empty = require("../../../google/protobuf/empty.js");
...
class Transaction$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.version !== void 0) writer.tag(3, import_runtime.WireType.Varint).int32(message.version);
    if (message.kind)
    ...
    if (message.sender !== void 0)
      writer.tag(5, import_runtime.WireType.LengthDelimited).string(message.sender);
...
class GasPayment$Type extends import_runtime4.MessageType {
  constructor() {
      ...
      switch (fieldNo) {
        ...
        1:
          message.objects.push(
            import_object_reference.ObjectReference.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
  ...
  internalBinaryWrite(message, writer, options) {
    for (let i = 0; i < message.objects.length; i++)
      import_object_reference.ObjectReference.internalBinaryWrite(
        message.objects[i],
        writer.tag(1, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
    if (message.owner !== void 0) writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.owner);
    if (message.price !== void 0) writer.tag(3, import_runtime.WireType.Varint).uint64(message.price);
    if (message.budget !== void 0) writer.tag(4, import_runtime.WireType.Varint).uint64(message.budget);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class TransactionExpiration$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.epoch !== void 0) writer.tag(2, import_runtime.WireType.Varint).uint64(message.epoch);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class TransactionKind$Type extends import_runtime4.MessageType {
  constructor() {
...
class ProgrammableTransaction$Type extends import_runtime4.MessageType {
  constructor() {
    super("sui.rpc.v2beta2.ProgrammableTransaction", [
      { no: 1, name: "inputs", kind: "message", repeat: 2, T: () => import_input.Input },
      {
        no: 2,
        name: "commands",
        kind: "message",
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          message.inputs.push(import_input.Input.internalBinaryRead(reader, reader.uint32(), options));
          break;
  ...
  internalBinaryWrite(message, writer, options) {
    for (let i = 0; i < message.inputs.length; i++)
      import_input.Input.internalBinaryWrite(
        message.inputs[i],
        writer.tag(1, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
...
class Command$Type extends import_runtime4.MessageType {
  constructor() {
...
class MoveCall$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        5:
          message.arguments.push(import_argument.Argument.internalBinaryRead(reader, reader.uint32(), options));
          break;
        default:
          let u = options.readUnknownField;
          if (u === "throw")
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.package !== void 0)
      writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.package);
    if (message.module !== void 0)
      writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.module);
    if (message.function !== void 0)
      writer.tag(3, import_runtime.WireType.LengthDelimited).string(message.function);
    for (let i = 0; i < message.typeArguments.length; i++)
      writer.tag(4, import_runtime.WireType.LengthDelimited).string(message.typeArguments[i]);
...
class TransferObjects$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          message.objects.push(import_argument.Argument.internalBinaryRead(reader, reader.uint32(), options));
          break;
        case /* optional sui.rpc.v2beta2.Argument address */
        2:
          message.address = import_argument.Argument.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.address
...
class SplitCoins$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          message.coin = import_argument.Argument.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.coin
        ...
        2:
          message.amounts.push(import_argument.Argument.internalBinaryRead(reader, reader.uint32(), options));
          break;
        default:
          let u = options.readUnknownField;
          if (u === "throw")
...
class MergeCoins$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        2:
          message.coinsToMerge.push(import_argument.Argument.internalBinaryRead(reader, reader.uint32(), options));
          break;
        default:
          let u = options.readUnknownField;
          if (u === "throw")
...
class Publish$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    for (let i = 0; i < message.modules.length; i++)
      writer.tag(1, import_runtime.WireType.LengthDelimited).bytes(message.modules[i]);
    for (let i = 0; i < message.dependencies.length; i++)
      writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.dependencies[i]);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class MakeMoveVector$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        2:
          message.elements.push(import_argument.Argument.internalBinaryRead(reader, reader.uint32(), options));
          break;
        default:
          let u = options.readUnknownField;
          if (u === "throw")
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.elementType !== void 0)
      writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.elementType);
...
class Upgrade$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        4:
          message.ticket = import_argument.Argument.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.ticket
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    for (let i = 0; i < message.dependencies.length; i++)
      writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.dependencies[i]);
    if (message.package !== void 0)
      writer.tag(3, import_runtime.WireType.LengthDelimited).string(message.package);
    if (message.ticket)
      import_argument.Argument.internalBinaryWrite(
        message.ticket,
        writer.tag(4, import_runtime.WireType.LengthDelimited).fork(),
...
class RandomnessStateUpdate$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.randomnessRound !== void 0)
      writer.tag(2, import_runtime.WireType.Varint).uint64(message.randomnessRound);
    if (message.randomBytes !== void 0)
      writer.tag(3, import_runtime.WireType.LengthDelimited).bytes(message.randomBytes);
    if (message.randomnessObjectInitialSharedVersion !== void 0)
      writer.tag(4, import_runtime.WireType.Varint).uint64(message.randomnessObjectInitialSharedVersion);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class ChangeEpoch$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        7:
          message.epochStartTimestamp = import_timestamp.Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.protocolVersion !== void 0)
      writer.tag(2, import_runtime.WireType.Varint).uint64(message.protocolVersion);
    if (message.storageCharge !== void 0)
      writer.tag(3, import_runtime.WireType.Varint).uint64(message.storageCharge);
    if (message.computationCharge !== void 0)
      writer.tag(4, import_runtime.WireType.Varint).uint64(message.computationCharge);
    if (message.storageRebate !== void 0)
      writer.tag(5, import_runtime.WireType.Varint).uint64(message.storageRebate);
    if (message.nonRefundableStorageFee !== void 0)
      writer.tag(6, import_runtime.WireType.Varint).uint64(message.nonRefundableStorageFee);
...
class SystemPackage$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.version !== void 0) writer.tag(1, import_runtime.WireType.Varint).uint64(message.version);
    for (let i = 0; i < message.modules.length; i++)
      writer.tag(2, import_runtime.WireType.LengthDelimited).bytes(message.modules[i]);
    for (let i = 0; i < message.dependencies.length; i++)
      writer.tag(3, import_runtime.WireType.LengthDelimited).string(message.dependencies[i]);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class GenesisTransaction$Type extends import_runtime4.MessageType {
  constructor() {
...
class ConsensusCommitPrologue$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        3:
          message.commitTimestamp = import_timestamp.Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.epoch !== void 0) writer.tag(1, import_runtime.WireType.Varint).uint64(message.epoch);
    if (message.round !== void 0) writer.tag(2, import_runtime.WireType.Varint).uint64(message.round);
    ...
    if (message.consensusCommitDigest !== void 0)
      writer.tag(4, import_runtime.WireType.LengthDelimited).string(message.consensusCommitDigest);
    if (message.subDagIndex !== void 0)
      writer.tag(5, import_runtime.WireType.Varint).uint64(message.subDagIndex);
    ...
    if (message.additionalStateDigest !== void 0)
      writer.tag(7, import_runtime.WireType.LengthDelimited).string(message.additionalStateDigest);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class VersionAssignment$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.startVersion !== void 0)
      writer.tag(2, import_runtime.WireType.Varint).uint64(message.startVersion);
...
class CanceledTransaction$Type extends import_runtime4.MessageType {
  constructor() {
...
class ConsensusDeterminedVersionAssignments$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.version !== void 0) writer.tag(1, import_runtime.WireType.Varint).int32(message.version);
...
class AuthenticatorStateUpdate$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.authenticatorObjectInitialSharedVersion !== void 0)
      writer.tag(4, import_runtime.WireType.Varint).uint64(message.authenticatorObjectInitialSharedVersion);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class ActiveJwk$Type extends import_runtime4.MessageType {
  constructor() {
...
class JwkId$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.kid !== void 0) writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.kid);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Jwk$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.kty !== void 0) writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.kty);
    if (message.e !== void 0) writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.e);
    if (message.n !== void 0) writer.tag(3, import_runtime.WireType.LengthDelimited).string(message.n);
    if (message.alg !== void 0) writer.tag(4, import_runtime.WireType.LengthDelimited).string(message.alg);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class EndOfEpochTransaction$Type extends import_runtime4.MessageType {
  constructor() {
...
class EndOfEpochTransactionKind$Type extends import_runtime4.MessageType {
  constructor() {
    super("sui.rpc.v2beta2.EndOfEpochTransactionKind", [
      ...
      },
      {
        ...
        kind: "message",
        oneof: "kind",
        T: () => import_empty.Empty
      },
      { no: 201, name: "randomness_state_create", kind: "message", oneof: "kind", T: () => import_empty.Empty },
      { no: 202, name: "deny_list_state_create", kind: "message", oneof: "kind", T: () => import_empty.Empty },
      {
        no: 203,
      ...
      { no: 205, name: "accumulator_root_create", kind: "message", oneof: "kind", T: () => import_empty.Empty },
      { no: 206, name: "coin_registry_create", kind: "message", oneof: "kind", T: () => import_empty.Empty }
    ]);
  }
  create(value) {
    const message = globalThis.Object.create(this.messagePrototype);
      ...
      switch (fieldNo) {
        ...
        200:
          message.kind = {
            ...
            authenticatorStateCreate: import_empty.Empty.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
        ...
        201:
          message.kind = {
            ...
            randomnessStateCreate: import_empty.Empty.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
        ...
        202:
          message.kind = {
            ...
            denyListStateCreate: import_empty.Empty.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
        ...
        205:
          message.kind = {
            ...
            accumulatorRootCreate: import_empty.Empty.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
        ...
        206:
          message.kind = {
            ...
            coinRegistryCreate: import_empty.Empty.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.kind.oneofKind === "authenticatorStateCreate")
      import_empty.Empty.internalBinaryWrite(
        message.kind.authenticatorStateCreate,
        writer.tag(200, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
    if (message.kind.oneofKind === "randomnessStateCreate")
      import_empty.Empty.internalBinaryWrite(
        message.kind.randomnessStateCreate,
        writer.tag(201, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
    if (message.kind.oneofKind === "denyListStateCreate")
      import_empty.Empty.internalBinaryWrite(
        message.kind.denyListStateCreate,
        writer.tag(202, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
    if (message.kind.oneofKind === "bridgeStateCreate")
      writer.tag(203, import_runtime.WireType.LengthDelimited).string(message.kind.bridgeStateCreate);
    if (message.kind.oneofKind === "bridgeCommitteeInit")
      writer.tag(204, import_runtime.WireType.Varint).uint64(message.kind.bridgeCommitteeInit);
    if (message.kind.oneofKind === "accumulatorRootCreate")
      import_empty.Empty.internalBinaryWrite(
        message.kind.accumulatorRootCreate,
        writer.tag(205, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
    if (message.kind.oneofKind === "coinRegistryCreate")
      import_empty.Empty.internalBinaryWrite(
        message.kind.coinRegistryCreate,
        writer.tag(206, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
...
class AuthenticatorStateExpire$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.minEpoch !== void 0) writer.tag(1, import_runtime.WireType.Varint).uint64(message.minEpoch);
    if (message.authenticatorObjectInitialSharedVersion !== void 0)
      writer.tag(2, import_runtime.WireType.Varint).uint64(message.authenticatorObjectInitialSharedVersion);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class ExecutionTimeObservations$Type extends import_runtime4.MessageType {
  constructor() {
...
class ExecutionTimeObservation$Type extends import_runtime4.MessageType {
  constructor() {
...
class ValidatorExecutionTimeObservation$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        2:
          message.duration = import_duration.Duration.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.duration
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.validator !== void 0)
      writer.tag(1, import_runtime.WireType.LengthDelimited).bytes(message.validator);
    if (message.duration)
      import_duration.Duration.internalBinaryWrite(
        message.duration,
        writer.tag(2, import_runtime.WireType.LengthDelimited).fork(),
        options
      ).join();
