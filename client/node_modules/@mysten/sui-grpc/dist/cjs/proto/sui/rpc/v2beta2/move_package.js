...
class Package$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.storageId !== void 0)
      writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.storageId);
    if (message.originalId !== void 0)
      writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.originalId);
...
class Module$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.contents !== void 0)
      writer.tag(2, import_runtime.WireType.LengthDelimited).bytes(message.contents);
...
class DatatypeDescriptor$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.typeName !== void 0)
      writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.typeName);
    if (message.definingId !== void 0)
      writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.definingId);
    if (message.module !== void 0)
      writer.tag(3, import_runtime.WireType.LengthDelimited).string(message.module);
    if (message.name !== void 0) writer.tag(4, import_runtime.WireType.LengthDelimited).string(message.name);
    ...
    if (message.kind !== void 0) writer.tag(7, import_runtime.WireType.Varint).int32(message.kind);
...
class TypeParameter$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.isPhantom !== void 0) writer.tag(2, import_runtime.WireType.Varint).bool(message.isPhantom);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class FieldDescriptor$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.name !== void 0) writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.name);
    if (message.position !== void 0) writer.tag(2, import_runtime.WireType.Varint).uint32(message.position);
    if (message.type)
...
class VariantDescriptor$Type extends import_runtime4.MessageType {
  constructor() {
...
class OpenSignatureBody$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.type !== void 0) writer.tag(1, import_runtime.WireType.Varint).int32(message.type);
    if (message.typeName !== void 0)
      writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.typeName);
    ...
    if (message.typeParameter !== void 0)
      writer.tag(4, import_runtime.WireType.Varint).uint32(message.typeParameter);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class FunctionDescriptor$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.name !== void 0) writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.name);
    if (message.visibility !== void 0) writer.tag(5, import_runtime.WireType.Varint).int32(message.visibility);
    if (message.isEntry !== void 0) writer.tag(6, import_runtime.WireType.Varint).bool(message.isEntry);
    for (let i = 0; i < message.typeParameters.length; i++)
      TypeParameter.internalBinaryWrite(
        message.typeParameters[i],
...
class OpenSignature$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.reference !== void 0) writer.tag(1, import_runtime.WireType.Varint).int32(message.reference);
    if (message.body)
      OpenSignatureBody.internalBinaryWrite(
        message.body,
...
class TypeOrigin$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.moduleName !== void 0)
      writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.moduleName);
    if (message.datatypeName !== void 0)
      writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.datatypeName);
    if (message.packageId !== void 0)
      writer.tag(3, import_runtime.WireType.LengthDelimited).string(message.packageId);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Linkage$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.originalId !== void 0)
      writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.originalId);
    if (message.upgradedId !== void 0)
      writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.upgradedId);
    if (message.upgradedVersion !== void 0)
      writer.tag(3, import_runtime.WireType.Varint).uint64(message.upgradedVersion);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
