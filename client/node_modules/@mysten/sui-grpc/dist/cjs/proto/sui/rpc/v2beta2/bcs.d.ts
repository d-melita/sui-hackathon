...
declare class Bcs$Type extends MessageType<Bcs> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Bcs): Bcs;
    internalBinaryWrite(message: Bcs, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
