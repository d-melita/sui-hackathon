...
declare class ExecutedTransaction$Type extends MessageType<ExecutedTransaction> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ExecutedTransaction): ExecutedTransaction;
    internalBinaryWrite(message: ExecutedTransaction, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
