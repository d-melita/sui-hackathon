...
class Struct$Type extends import_runtime6.MessageType {
  constructor() {
  ...
  internalJsonRead(json, options, target) {
    if (!(0, import_runtime4.isJsonObject)(json))
      throw new globalThis.Error(
        "Unable to parse message " + this.typeName + " from JSON " + (0, import_runtime5.typeofJsonValue)(json) + "."
      );
  ...
  internalBinaryWrite(message, writer, options) {
    for (let k of globalThis.Object.keys(message.fields)) {
      writer.tag(1, import_runtime.WireType.LengthDelimited).fork().tag(1, import_runtime.WireType.LengthDelimited).string(k);
...
class Value$Type extends import_runtime6.MessageType {
  constructor() {
  ...
  internalJsonRead(json, options, target) {
    ...
    switch (typeof json) {
      ...
      default:
        throw new globalThis.Error(
          "Unable to parse " + this.typeName + " from JSON " + (0, import_runtime5.typeofJsonValue)(json)
        );
    }
    return target;
  }
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.kind.oneofKind === "nullValue")
      writer.tag(1, import_runtime.WireType.Varint).int32(message.kind.nullValue);
    if (message.kind.oneofKind === "numberValue")
      writer.tag(2, import_runtime.WireType.Bit64).double(message.kind.numberValue);
    if (message.kind.oneofKind === "stringValue")
      writer.tag(3, import_runtime.WireType.LengthDelimited).string(message.kind.stringValue);
    if (message.kind.oneofKind === "boolValue")
      writer.tag(4, import_runtime.WireType.Varint).bool(message.kind.boolValue);
...
class ListValue$Type extends import_runtime6.MessageType {
  constructor() {
