...
class Any$Type extends import_runtime7.MessageType {
  constructor() {
  ...
  internalJsonWrite(any, options) {
    ...
    let opt = (0, import_runtime6.jsonWriteOptions)(options);
    ...
    if (typeName.startsWith("google.protobuf.") || !(0, import_runtime4.isJsonObject)(json)) json = { value: json };
  ...
  internalJsonRead(json, options, target) {
    if (!(0, import_runtime4.isJsonObject)(json))
      throw new globalThis.Error(
        "Unable to parse google.protobuf.Any from JSON " + (0, import_runtime5.typeofJsonValue)(json) + "."
      );
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.typeUrl !== "") writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.typeUrl);
    if (message.value.length) writer.tag(2, import_runtime.WireType.LengthDelimited).bytes(message.value);
