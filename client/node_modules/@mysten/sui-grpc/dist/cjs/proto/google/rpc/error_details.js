...
class ErrorInfo$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.reason !== "") writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.reason);
    if (message.domain !== "") writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.domain);
    for (let k of globalThis.Object.keys(message.metadata))
      writer.tag(3, import_runtime.WireType.LengthDelimited).fork().tag(1, import_runtime.WireType.LengthDelimited).string(k).tag(2, import_runtime.WireType.LengthDelimited).string(message.metadata[k]).join();
...
class RetryInfo$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          message.retryDelay = import_duration.Duration.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.retryDelay
...
class DebugInfo$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    for (let i = 0; i < message.stackEntries.length; i++)
      writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.stackEntries[i]);
    if (message.detail !== "") writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.detail);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class QuotaFailure$Type extends import_runtime4.MessageType {
  constructor() {
...
class QuotaFailure_Violation$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.subject !== "") writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.subject);
...
class PreconditionFailure$Type extends import_runtime4.MessageType {
  constructor() {
...
class PreconditionFailure_Violation$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.type !== "") writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.type);
    if (message.subject !== "") writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.subject);
    if (message.description !== "")
...
class BadRequest$Type extends import_runtime4.MessageType {
  constructor() {
...
class BadRequest_FieldViolation$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.field !== "") writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.field);
    if (message.description !== "")
      writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.description);
    if (message.reason !== "") writer.tag(3, import_runtime.WireType.LengthDelimited).string(message.reason);
...
class RequestInfo$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.requestId !== "") writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.requestId);
    if (message.servingData !== "")
      writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.servingData);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class ResourceInfo$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.resourceType !== "")
      writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.resourceType);
    if (message.resourceName !== "")
      writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.resourceName);
    if (message.owner !== "") writer.tag(3, import_runtime.WireType.LengthDelimited).string(message.owner);
    if (message.description !== "")
...
class Help$Type extends import_runtime4.MessageType {
  constructor() {
...
class Help_Link$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.url !== "") writer.tag(2, import_runtime.WireType.LengthDelimited).string(message.url);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? import_runtime2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class LocalizedMessage$Type extends import_runtime4.MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.locale !== "") writer.tag(1, import_runtime.WireType.LengthDelimited).string(message.locale);
