 ...
 */
export declare enum UnchangedSharedObject_UnchangedSharedObjectKind {
    /**
...
declare class TransactionEffects$Type extends MessageType<TransactionEffects> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: TransactionEffects): TransactionEffects;
    internalBinaryWrite(message: TransactionEffects, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
declare class ChangedObject$Type extends MessageType<ChangedObject> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ChangedObject): ChangedObject;
    internalBinaryWrite(message: ChangedObject, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
declare class UnchangedSharedObject$Type extends MessageType<UnchangedSharedObject> {
    constructor();
    create(value?: PartialMessage<UnchangedSharedObject>): UnchangedSharedObject;
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UnchangedSharedObject): UnchangedSharedObject;
    internalBinaryWrite(message: UnchangedSharedObject, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta2.UnchangedSharedObject
 */
export declare const UnchangedSharedObject: UnchangedSharedObject$Type;
export {};
