...
class CoinMetadata$Type extends MessageType {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.decimals !== void 0) writer.tag(2, WireType.Varint).uint32(message.decimals);
    if (message.name !== void 0) writer.tag(3, WireType.LengthDelimited).string(message.name);
...
class GetBalanceRequest$Type extends MessageType {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.owner !== void 0) writer.tag(1, WireType.LengthDelimited).string(message.owner);
    if (message.coinType !== void 0)
...
class ListBalancesRequest$Type extends MessageType {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.owner !== void 0) writer.tag(1, WireType.LengthDelimited).string(message.owner);
    if (message.pageSize !== void 0) writer.tag(2, WireType.Varint).uint32(message.pageSize);
...
class Balance$Type extends MessageType {
  ...
  internalBinaryWrite(message, writer, options) {
    if (message.coinType !== void 0)
      writer.tag(1, WireType.LengthDelimited).string(message.coinType);
    if (message.balance !== void 0) writer.tag(3, WireType.Varint).uint64(message.balance);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class SimulateTransactionRequest$Type extends MessageType {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.checks !== void 0) writer.tag(3, WireType.Varint).int32(message.checks);
...
const LiveDataService = new ServiceType("sui.rpc.v2beta2.LiveDataService", [
  {
