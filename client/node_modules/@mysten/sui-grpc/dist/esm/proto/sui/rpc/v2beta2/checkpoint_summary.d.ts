...
declare class CheckpointSummary$Type extends MessageType<CheckpointSummary> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckpointSummary): CheckpointSummary;
    internalBinaryWrite(message: CheckpointSummary, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
declare class EndOfEpochData$Type extends MessageType<EndOfEpochData> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: EndOfEpochData): EndOfEpochData;
    internalBinaryWrite(message: EndOfEpochData, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
...
declare class CheckpointCommitment$Type extends MessageType<CheckpointCommitment> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CheckpointCommitment): CheckpointCommitment;
    internalBinaryWrite(message: CheckpointCommitment, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter;
}
/**
